...
export default function Logo() {
  return (
    <AnchorLink
      href="/"
      aria-label="OfflinePass home"
      className="group inline-flex items-center gap-2.5"
    >
      <span className="relative inline-flex h-8 w-8 items-center justify-center rounded-lg bg-brand text-white shadow-sm transition-transform duration-300 group-hover:-translate-y-0.5">
        <svg
      ...
      <span className="text-lg lg:text-xl font-semibold tracking-tight text-brand">
        OfflinePass
      </span>
    </AnchorLink>
  );
