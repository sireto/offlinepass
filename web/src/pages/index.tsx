...
export default function Home() {
  return (
    <div className="flex flex-col lg:flex-row md:space-y-8 lg:px-28 lg:space-y-0 w-full h-full justify-between">
      <BannerContainer className="w-full h-full lg:w-1/2" />
