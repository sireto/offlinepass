...
var Jotai__namespace = /*#__PURE__*/_interopNamespaceDefault(Jotai);
...
var useAtomValue = function useAtomValue() {
  console.warn('[DEPRECATED]: use `useAtomValue` from `jotai` instead.');
  return Jotai__namespace.useAtomValue.apply(Jotai__namespace, arguments);
};
var useUpdateAtom = function useUpdateAtom() {
  console.warn('[DEPRECATED]: use `useSetAtom` from `jotai` instead.');
  return Jotai__namespace.useSetAtom.apply(Jotai__namespace, arguments);
};
